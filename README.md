...
An ardent Cloud Computing, Development Operations and Information Security professional with over 6+ years of experience in the Information Technology industry comprising Software Development Operations, Software Development Security Operations, Site Reliability, AWS Cloud Infrastructure, Systems Administration, Information Security and Data Privacy, and an ISACA Certified Data Privacy Solutions Engineer. Having excelling skills in automation, build/release management, container orchestration, configuration and management of various Linux systems distributions. Hands-on experience in Git/GitHub, Docker, Kubernetes, Jenkins, Ansible, Terraform, AWS Cloud, and on-premises deployment, with added proficiency in Python, JavaScript, Bash Shell, and PowerShell scripting. 
...
#### *Cloud:* 
| AWS cloud | DevOps | S3 | CI / CD Pipeline | Container Platform: Kubernetes / Docker | Serverless: EC2 / Lambda | Integration Technologies/APIs: XML / (S)FTP | Continous Intergration: Jenkins / Chef | Continous Deployment: Jenkins / Ansible | Configuration Management: Ansible / Puppet | Continous Monitoring: Kubernetes | Infrastructure Provisioning: Terraform | Automation: Gradle / Maven | Version Control Systems: Git / Github / Gitlab / AWS CodeCommit | Testing/Deployment: Golang / Go / Python / Python Django / Javascript | Ticket Tracking: Confluence / ServiceNow | Load Balancer: HAProxy | Code Quality Intergration : SonarQube | Scrum/Agile Project Management: Jira-kanban board | Web/App Server: Apache, Tomcat, Nginx, gunicorn | Resources/Network Monitoring: Nagios, Splunk | 
...
#### *Languages:*
| Python | Bash Shell | Batch / PowerShell | HTML5 / XML | C / C++ | 
...
* Conducted security assessments of the institution’s sites containing 10,000+ users, ensuring safe cyberspace.
...
* Gained experience tuning and improving the company’s overall e-mail security gaining a 90% efficiency rate.
