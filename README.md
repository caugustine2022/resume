...
An ardent, proactive, result-oriented professional in Software Development Operations Engineering, and Cloud Computing, with over 6+ years of experience in the Information Technology industry comprising Security and Software Development Operations, Site Reliability Engineering, Cloud Infrastructure, Systems Administration, and an ISACA Certified Data Privacy Solutions Engineer. Having excelling development operations skills in build and release management, cloud architectures, continuous integration and deployment, infrastructure provisioning and automation, container orchestrations, configurations, and management of Linux systems distributions. In addition, hands-on experience in development operations tools and methodologies such as Git/GitHub, Docker, Kubernetes, Jenkins, Ansible, Terraform, and on-premises deployment, with added proficiency in Python, Bash, Groovy, YAML, and PowerShell scripting. Finally, cutting-edge training and skills in identity access management, enterprise security control frameworks, endpoint security, network security, data governance, and risk management/compliances, with a deep passion for enterprise-wide security management. Persistent, detailed-oriented with excellent interpersonal and team-working skills, and passionate about contributing my technical and analytical skills to ensure operational efficiency. 
