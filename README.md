...
Information technology and cybersecurity enthusiast with over 6+ years of experience in the information technology industry. Over 5+ years of experience in the domain of Site Reliability Engineering, Development Operations, Development Security Operations, AWS Cloud Infrastructure, and Linux Systems Engineering; with excelling skills in automation, container orchestration, managing, and configuring various Linux systems distributions: Ubuntu, CentOS, RedHat, Debian, Oracle Linux, and Kali Linux. Hands-on experience in Git/GitHub, sonarQube, Jenkins, Ansible, Docker, Kubernetes, Terraform, AWS Cloud, and on-premises deployment, with added proficiency in Java, JavaScript, Python, Bash Shell, and PowerShell scripting. 
